...
# translation
SOURCES = helloplugin.py ui_helloplugin.py __init__.py helloplugindialog.py
#TRANSLATIONS = i18n/helloplugin_en.ts
TRANSLATIONS = 
...
PY_FILES = helloplugin.py helloplugindialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_helloplugin.py
